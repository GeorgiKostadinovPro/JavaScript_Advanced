...
describe('Tests for the rgbToHexColor function', () => {
    it('Sould return undefined when red param is not integer', () => {
        expect(rgbToHexColor(100.5, 255, 255)).to.be.undefined;
    });

    it('Sould return undefined when red param is less than zero', () => {
        expect(rgbToHexColor(-1, 255, 255)).to.be.undefined;
    });

    it('Sould return undefined when red param is bigger than 255', () => {
        expect(rgbToHexColor(256, 255, 255)).to.be.undefined;
    });

    it('Sould return undeined when green param is not integer', () => {
        expect(rgbToHexColor(255, 100.5, 255)).to.be.undefined;
    });

    it('Sould return undefined when green param is less than zero', () => {
        expect(rgbToHexColor(255, -1, 255)).to.be.undefined;
    });

    it('Sould return undefined when green param is bigger than 255', () => {
        expect(rgbToHexColor(255, 256, 255)).to.be.undefined;
    });

    it('Sould return undefined when blue param is not integer', () => {
        expect(rgbToHexColor(255, 255, 100.5)).to.be.undefined;
    });

    it('Sould return undefined when blue param is less than zero', () => {
        expect(rgbToHexColor(255, 255, -1)).to.be.undefined;
    });

    it('Sould return undefined when blue param is bigger than 255', () => {
